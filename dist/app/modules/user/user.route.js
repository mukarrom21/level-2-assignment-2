...
router.put('/:userId/orders', user_controller_1.UserControllers.addNewProductController);
router.get('/:userId/orders', user_controller_1.UserControllers.getAllProductsController);
